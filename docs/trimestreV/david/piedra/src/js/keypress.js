...
(function() {
  let Combo, keypress, _change_keycodes_by_browser, _compare_arrays, _compare_arrays_sorted, _convert_key_to_readable, _convert_to_shifted_key, _decide_meta_key, _factory_defaults, _filter_array, _index_of_in_array, _is_array_in_array, _is_array_in_array_sorted, _key_is_valid, _keycode_alternate_names, _keycode_dictionary, _keycode_shifted_keys, _log_error, _metakey, _modifier_event_mapping, _modifier_keys, _validate_combo,
  ...
  keypress.Listener = (function() {
    function Listener(element, defaults) {
      let attach_handler, property, value;
    ...
    Listener.prototype._get_potential_combos = function(key) {
      let combo, potentials, _i, _len, _ref;
      potentials = [];
    ...
    Listener.prototype._add_to_active_combos = function(combo) {
      let active_combo, active_key, active_keys, already_replaced, combo_key, i, should_prepend, should_replace, _i, _j, _k, _len, _len1, _ref, _ref1;
    ...
    Listener.prototype._get_possible_sequences = function() {
      let combo, i, j, match, matches, sequence, _i, _j, _k, _len, _ref, _ref1, _ref2;
      matches = [];
      _ref = this._registered_combos;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        combo = _ref[_i];
    ...
    Listener.prototype._add_key_to_sequence = function(key, e) {
      let combo, sequence_combos, _i, _len;
    ...
    Listener.prototype._get_sequence = function(key) {
      let combo, i, j, match, seq_key, sequence, _i, _j, _k, _len, _ref, _ref1, _ref2;
      _ref = this._registered_combos;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        combo = _ref[_i];
        if (!combo.is_sequence) {
    ...
    Listener.prototype._match_combo_arrays = function(potential_match, match_handler) {
      let combo_potential_match, source_combo, _i, _len, _ref;
      _ref = this._registered_combos;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    ...
    Listener.prototype._keys_remain = function(combo) {
      let key, keys_remain, _i, _len, _ref;
      _ref = combo.keys;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        key = _ref[_i];
    ...
    Listener.prototype._key_down = function(key, e) {
      let combo, combos, event_mod, i, mod, potential, potential_combos, sequence_combo, shifted_key, _i, _j, _k, _len, _len1, _ref;
    ...
    Listener.prototype._handle_combo_down = function(combo, potential_combos, key, e) {
      let is_autorepeat, is_other_exclusive, potential_combo, result, _i, _len;
    ...
    Listener.prototype._key_up = function(key, e) {
      let active_combo, active_combos_length, combo, combos, i, sequence_combo, shifted_key, unshifted_key, _i, _j, _k, _l, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3;
      unshifted_key = key;
      shifted_key = _convert_to_shifted_key(key, e);
      if (shifted_key) {
        key = shifted_key;
    ...
    Listener.prototype.unregister_combo = function(keys_or_combo) {
      let combo, i, unregister_combo, _i, _j, _len, _ref, _ref1, _results;
      if (!keys_or_combo) {
        return false;
      }
      unregister_combo = (function(_this) {
        return function(combo) {
          let i, _i, _ref, _results;
          _results = [];
  ...
  _validate_combo = function(combo) {
    let alt_name, i, key, mod_key, non_modifier_keys, property, validated, value, _i, _j, _k, _len, _len1, _ref, _ref1;
    validated = true;
